...
package SpringBootStarterRpcJson
...
import (
	...
	"github.com/go-spring/go-spring-boot-starter/spring-boot-rpc"
)

func init() {
	SpringBoot.RegisterModule(func(context SpringCore.SpringContext) {
		container := &SpringRpcJson.SpringRpcJsonContainer{}
		context.RegisterBean(container)
		context.RegisterBean(SpringBootRpc.Wrapper(container))
	})
}
